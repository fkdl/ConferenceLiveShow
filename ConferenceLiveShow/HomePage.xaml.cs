...
namespace ConferenceLiveShow
{
    ...
    public sealed partial class HomePage : Page
    {
        ...
        EventHubHelper _eventHubHelper;
        ...
        private void ShowFromFaceApi(Size frameSize, CustomFaceModel[] customFaces, EmojiNum emojiNum)
        //private void ShowFromFaceApi(Size frameSize, CustomFaceModel[] customFaces)
        {
            ...
            if (_state == StreamingState.Streaming && customFaces != null)
            {
                ...
                for (int i = 0; i < customFaces.Length; i++)
                {
                    Rectangle box = new Rectangle()
                    {
                        Width = (uint)(customFaces[i].Width / widthScale),
                        Height = (uint)(customFaces[i].Height / heightScale),
                        Fill = fillBrush,
                        StrokeThickness = lineThickness,
                        Stroke = lineBrush,
                    ...
                    Grid grid = new Grid()
                    {
                        ...
                        Width = (customFaces[i].Width / widthScale),
